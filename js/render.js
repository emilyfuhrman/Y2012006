...
function getData(){
	$.ajax({
		...
		success : function(parsed_json) {
			jloc	= parsed_json['location']['city'].toUpperCase();
			jtemp	= parsed_json['current_observation']['temp_f'];
			jhum	= parsed_json['current_observation']['relative_humidity'].replace("%","");
			jindex	= parsed_json['current_observation']['feelslike_f'];
			jwind	= parsed_json['current_observation']['wind_dir'].toUpperCase();
